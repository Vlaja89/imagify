...
register_nav_menus(
    array(
        'menu_center' => __('Menu Center', 'theme'),
        'menu_right' => __('Menu Right', 'theme'),
        'menu_footer' => __('Footer Menu', 'theme'),
    )
    );
...
function register_acf_block_types(){
    acf_register_block_type(array(
        'name' => 'block_icon_columns',
        'title' => _('Block Icon Columns'),
        'description' => _('A custom Block Icon Columns Box'),
        'render_template' => 'template-parts/blocks/block-icon-columns.php',
        'icon' => 'editor-paste-text',
        'keywords' => array('block_icon_columns', 'product'),
    ));
}